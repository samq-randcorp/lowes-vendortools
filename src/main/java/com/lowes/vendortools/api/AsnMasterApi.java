...
public class AsnMasterApi {
    ...
    /**
     * Build call for getASNStatusByTransactionIdAndOrderNumber
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getASNStatusByTransactionIdAndOrderNumberCall(String orderNumber, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/asn/order/{orderNumber}"
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getASNStatusByTransactionIdAndOrderNumberValidateBeforeCall(String orderNumber, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'orderNumber' is set
        if (orderNumber == null) {
            throw new ApiException("Missing the required parameter 'orderNumber' when calling getASNStatusByTransactionIdAndOrderNumber(Async)");
        }
        
        com.squareup.okhttp.Call call = getASNStatusByTransactionIdAndOrderNumberCall(orderNumber, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ValidatedASNView getASNStatusByTransactionIdAndOrderNumber(String orderNumber) throws ApiException {
        ApiResponse<ValidatedASNView> resp = getASNStatusByTransactionIdAndOrderNumberWithHttpInfo(orderNumber);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ValidatedASNView> getASNStatusByTransactionIdAndOrderNumberWithHttpInfo(String orderNumber) throws ApiException {
        com.squareup.okhttp.Call call = getASNStatusByTransactionIdAndOrderNumberValidateBeforeCall(orderNumber, null, null);
        Type localVarReturnType = new TypeToken<ValidatedASNView>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get ASN Information By Order Number (asynchronously)
     * 
     * @param orderNumber  (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getASNStatusByTransactionIdAndOrderNumberAsync(String orderNumber, final ApiCallback<ValidatedASNView> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getASNStatusByTransactionIdAndOrderNumberValidateBeforeCall(orderNumber, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ValidatedASNView>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for getASNStatusByTransactionIdAndOrderNumberAndLoadId
     * @param orderNumber  (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getASNStatusByTransactionIdAndOrderNumberAndLoadIdCall(String orderNumber, String loadId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/asn/{orderNumber}/{loadId}"
            .replaceAll("\\{" + "orderNumber" + "\\}", apiClient.escapeString(orderNumber.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getASNStatusByTransactionIdAndOrderNumberAndLoadIdValidateBeforeCall(String orderNumber, String loadId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'orderNumber' is set
        if (orderNumber == null) {
            throw new ApiException("Missing the required parameter 'orderNumber' when calling getASNStatusByTransactionIdAndOrderNumberAndLoadId(Async)");
        }
        // verify the required parameter 'loadId' is set
        if (loadId == null) {
            throw new ApiException("Missing the required parameter 'loadId' when calling getASNStatusByTransactionIdAndOrderNumberAndLoadId(Async)");
        }
        
        com.squareup.okhttp.Call call = getASNStatusByTransactionIdAndOrderNumberAndLoadIdCall(orderNumber, loadId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ValidatedASNView getASNStatusByTransactionIdAndOrderNumberAndLoadId(String orderNumber, String loadId) throws ApiException {
        ApiResponse<ValidatedASNView> resp = getASNStatusByTransactionIdAndOrderNumberAndLoadIdWithHttpInfo(orderNumber, loadId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ValidatedASNView> getASNStatusByTransactionIdAndOrderNumberAndLoadIdWithHttpInfo(String orderNumber, String loadId) throws ApiException {
        com.squareup.okhttp.Call call = getASNStatusByTransactionIdAndOrderNumberAndLoadIdValidateBeforeCall(orderNumber, loadId, null, null);
        Type localVarReturnType = new TypeToken<ValidatedASNView>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get ASN Information By  Order Number and LoadId (asynchronously)
     * 
     * @param orderNumber  (required)
     * @param loadId  (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getASNStatusByTransactionIdAndOrderNumberAndLoadIdAsync(String orderNumber, String loadId, final ApiCallback<ValidatedASNView> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getASNStatusByTransactionIdAndOrderNumberAndLoadIdValidateBeforeCall(orderNumber, loadId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ValidatedASNView>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
